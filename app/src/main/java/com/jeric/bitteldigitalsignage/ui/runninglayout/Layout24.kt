...
class Layout24 @JvmOverloads constructor(
    context: Context,
    ...
    fun setData(data: List<EventFeedModel>,media: String) {
    ...
    private class ScrollHandler(mView: Layout24?) : Handler() {
        private val view: WeakReference<Layout24?> = WeakReference(mView)
    ...
    private class MyAdapter : RecyclerView.Adapter<ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view: View = LayoutInflater.from(parent.context)
                .inflate(R.layout.feed_item_024, parent, false)
    ...
    init {
        inflate(context, R.layout.feed_024, this)
        mHandler = ScrollHandler(this)
        mAdapter = MyAdapter()
        recyclerView = findViewById<View>(R.id.layout24) as RecyclerView
